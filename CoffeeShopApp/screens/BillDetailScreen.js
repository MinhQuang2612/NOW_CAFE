...
//           <Text style={styles.nameText}>{user?.name || "Nguyen Thi Nu Y"}</Text>
//           <Text style={styles.phoneText}>(+84) {user?.phoneNumber || "0123456791"}</Text>
//           <Text style={styles.addressText}>{user?.address || "Danang, Vietnam"}</Text>
//         </View>
//       </View>
//     );
//   };
...
//       <View style={styles.deliveryDetailContainer}>
//         <Image
//           source={require("../assets/images/deliveryItem.png")}
//           resizeMode="cover"
//         />
//         <View>
//           <Text style={styles.deliveryName}>Fast Delivery</Text>
...
//             {voucher ? voucher.title : "Free ship: HAPPY DAY"}
//           </Text>
//           <Text>
//             {voucher
//               ? voucher.description.length > 30
...
//         <View style={styles.itemContainer}>
//           {selectedItems.length > 0 ? (
//             selectedItems.map((item, index) => <Item item={item} key={index} />)
//           ) : (
//             <Text>No items</Text>
//           )}
